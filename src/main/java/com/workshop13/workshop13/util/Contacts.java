package com.workshop13.workshop13.util;
...
public class Contacts {
    ...
    public static void saveToFile(Contact contact, String fileDir) {
        ...
        try(BufferedWriter bw = Files.newBufferedWriter(file, Charset.forName("UTF-8"))) {
            // System.out.println("Contacts.saveToFile: writing to file");
            bw.write(content);
            bw.flush();
        } catch (IOException e) {}
    ...
    public static Contact getContact(String id, String fileDir) {
        ...
        try {
            ...
            contact.setPhoneNumber(contents.get(2));
            contact.setDateOfBirth(contents.get(3));
